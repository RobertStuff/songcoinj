...
public class Block extends Message {
    ...
    private Sha256Hash calculateHash() {
            //  log.warn("nonce = " + nonce + " remember gen: 1591189");
          //  log.warn("Trying to calculate Hash..  why here in Block.java? time = " + getTimeSeconds());
        // special case for genesis block? 
        if (nonce==2360922209L && time==1409546382) {
                    log.warn("ok lets do this shit by hand holmes - genesis hash comin atya");
            return new Sha256Hash(Utils.HEX.decode("c2e1053b8b32c0aba8039421206c6760558d4fcd264394834fcf00a3245eca91")); 
        }       
        try {
    ...
    private void checkTimestamp() throws VerificationException {
        ...
        log.warn("checkTimeStamp passed");
    }
